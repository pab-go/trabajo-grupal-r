...
author: "Pablo Gómez (DNI: 03214857D), Wenxiang Xia (DNI:X7276507C), 
Javier Figueiredo Tor (DNI:06341629T), Cyan Morales (DNI: 02780780B)"
format:
  revealjs:
    theme: [style.scss]
...
censo_por_eleccion <- election_data |> 
  ...
  slice(1)|> 
  ungroup() |> 
  summarise(censo_total = sum(censo, na.rm = TRUE),.by=fecha)  # Sumar el censo por elección

---
title: '[Entrega grupal]{style="color:green; font-weight: bold;"}'
author:
...
format:
  revealjs:
    ...
    slideNumber: true
    footer: '[Entrega Grupal del Equipo 7]{style="color:blue; font-weight: bold;"} · Grado en Ciencia de Datos Aplicada (UCM)'
    plugins: ["menu"]
    menu:
...
La práctica se basará en los [**archivos de datos electorales**]{.hl-yellow}
...
### Convirtiendo los datos a tidydata.
...
### Información = Varianza: Eliminando columnas con un único valor.
...
### Siglas de los partidos políticos.
...
### ¿Qué partido fue el segundo cuando el primero fue el PSOE?
...
### ¿Cómo analizar la relación entre censo y voto?
...
### 1. ¿Ha subido el peso de los grandes partidos, de los partidos nacionalistas y de los partidos nuevos a lo largo del tiempo?
...
### 3. ¿Existen diferencias significativas en los patrones de votos nulos, blancos y no votados entre municipios urbanos y rurales?
...
.animated-title {
  ...
  display: inline-block;    /* Ensure proper rendering for animations */
  animation: colorChange 2s infinite; /* Apply animation with 2s duration */
}
</style>

# <span class="animated-title">¡Muchas gracias!</span>

<div style="text-align: center;">
Pablo Gómez, Wenxiang Xia, Javier Figueiredo, Cyan Morales.
</div>
